...
export default function Editor() {
	 ...
	 */
	const clearSource = () => {
		const newEditorState = getEditorDraftInitialState();
		setEditorState(newEditorState);
		setLastSaveState(null);
