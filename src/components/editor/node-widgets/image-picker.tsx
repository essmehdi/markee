...
export default function ImagePicker() {
  ...
  const insertEncodedImage = useEditorEventCallback(
    (view, encodedImage: string) => {
  ...
  const updateToolbarPosition = useEditorEventCallback((view) => {
    ...
    if (hidden) {
      ...
      const editorContainerClientRect =
  ...
  return (
    ...
    >
      <label
        htmlFor="editor-image-picker"
        className="block cursor-pointer px-10 py-7"
      >
