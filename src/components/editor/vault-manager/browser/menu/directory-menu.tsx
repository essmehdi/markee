...
export default function BrowserDirectoryMenuContent({
  ...
  return (
    <ContextMenuContent>
      ...
      <ContextMenuSeparator />
      <ContextMenuItem
        onSelect={() => setClipboard({ items: [directory], move: false })}
      >
        Copy
        <ContextMenuShortcut>
      ...
      <ContextMenuItem
        onSelect={() => setClipboard({ items: [directory], move: true })}
      >
        Cut
        <ContextMenuShortcut>
      ...
      <ContextMenuItem
        disabled={
          ...
          clipboard.items.find(
            (item) => item.absolutePath === directory.absolutePath
          ) !== undefined
        }
        onSelect={() =>
          clipboard.move
      ...
      >
        Paste
        <ContextMenuShortcut>
          {getHotkeyText(BROWSER_HOTKEYS.PASTE_HOTKEY)}
        </ContextMenuShortcut>
      </ContextMenuItem>
      <ContextMenuSeparator />
      <ContextMenuItem
        className="text-destructive"
        onSelect={promptRemoveDirectory}
      >
        Remove
      </ContextMenuItem>
    </ContextMenuContent>
